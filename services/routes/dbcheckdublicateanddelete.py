...
router = APIRouter(tags=["db-checkdublicateanddelete"])
...
@router.get("/dbcheckdublicateanddelete-schemas")
def dbcheckdublicateanddelete_schemas(conn_name: str):
...
@router.get("/dbcheckdublicateanddelete-datasets")
def dbcheckdublicateanddelete_datasets(conn_name: str, schema_name: str):
    conn_name = (conn_name or "").strip()
...
@router.get("/dbcheckdublicateanddelete-fields")
def dbcheckdublicateanddelete_fields(conn_name: str, schema_name: str, dataset_name: str):
    conn_name = (conn_name or "").strip()
    schema_name = (schema_name or "").strip()
...
@router.post("/dbcheckdublicateanddelete-analyze")
def dbcheckdublicateanddelete_analyze(req: AnalyzeReq):
...
@router.post("/dbcheckdublicateanddelete-delete")
def dbcheckdublicateanddelete_delete(req: DeleteReq):
    conn_name = (req.conn_name or "").strip()
    schema_name = (req.schema_name or "").strip()
    dataset_name = (req.dataset_name or "").strip()
