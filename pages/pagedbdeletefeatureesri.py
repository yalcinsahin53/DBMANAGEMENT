...
def build_dbdeletefeatureesri_view(page: ft.Page) -> ft.Control:
    ...
    async def _load_schemas_for_conn(conn_name: str):
        ...
        try:
            res = await asyncio.to_thread(page.api.dbdeletefeatureesri_list_schemas, conn_name)
        finally:
            _set_busy(False)
    ...
    async def on_list_click(e):
        ...
        try:
            res = await asyncio.to_thread(
                page.api.dbdeletefeatureesri_list_datasets,
                conn_name,
                schema_name,
            )
        finally:
    ...
    def _confirm_delete_dialog():
        ...
        async def _delete_now():
            ...
            try:
                res = await asyncio.to_thread(
                    page.api.dbdeletefeatureesri_delete_datasets,
                    conn_name,
                    schema_name,
                    selected,
                )
